...
> 当前最佳STOA实践是Claude的Skills攻略，此处不介绍，如涉及复杂项目可考虑(个人还没试过)。
...
大多数情况下，builder就可以完成开发任务，要熟悉存量项目架构设计的话可以使用chat模型。建议先在buidler模式下，自动生成团队规范。提示词如下
...
AI协同并不简单，让开发人员最讨论的文档编写，直接上升到第一公民，变成**面向文档编程**了。协同原则总结：
